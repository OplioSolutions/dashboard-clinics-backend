...
class ConversationController extends base_1.BaseController {
    ...
    async startConversation(req, res) {
        return this.handleRequest(req, res, async () => {
            ...
            if (activeConversation) {
                ...
                if (initial_message) {
                    await this.getSupabase(req)
                        ...
                        channel: channel || message_1.Channel.WHATSAPP,
            ...
            const newConversation = {
                ...
                channels_used: channel ? [channel] : [message_1.Channel.WHATSAPP],
                status: 'active',
